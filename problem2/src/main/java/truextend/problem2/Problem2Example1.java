...
public class Problem2Example1 
{
	...
	static{
		...
		studentList.add(new Student("John Wilson", new LatLon("34.069149","-118.440193")));
		...
		classroomList.add(new Classroom("Introductory Psychobiology", new LatLon("34.070223","-118.440193")));
